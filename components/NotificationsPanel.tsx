 ...
 *
 * Rows arrive over Realtime as the booking triggers write them, so a customer
 * watching this page sees "a pro claimed your job" without touching anything.
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // The notification means booking state changed — pull the fresh
          // bookings list and minute balance rendered by the server.
          router.refresh()
        },
      )
      .subscribe((status) => {
