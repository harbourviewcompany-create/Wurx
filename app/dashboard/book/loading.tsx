...
export default function BookLoading() {
  return (
    <section className="container section" aria-busy="true" aria-label="Loading services">
      ...
      <div className="skeleton" style={{ height: 52, borderRadius: 6, marginTop: 18 }} />
      <div className="chip-row" style={{ marginTop: 14 }}>
        <div className="skeleton" style={{ height: 34, width: 110, borderRadius: 4 }} />
        <div className="skeleton" style={{ height: 34, width: 104, borderRadius: 4 }} />
        <div className="skeleton" style={{ height: 34, width: 118, borderRadius: 4 }} />
      </div>
